...
Het downloaden van grotere domeintabellen kan behoorlijk wat tijd in beslag nemen. Daarom maakt *aquodom* gebruik van caching. Als een domeintabel eenmaal is gedownload wordt in dezelfde R-sessie gebruik gemaakt van de cache. 
...
Het is mogelijk om de cache persistent te maken over meerdere R-sessies. Een betere optie is echter om gebruik te maken van de functie `dom_save()` om de domeintabel op de schijf op te slaan.
